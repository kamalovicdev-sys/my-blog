...
![Ubuntu]([https://linuxiac.com/wp-content/uploads/2020/06/ubuntu-linux.jpg](https://cdn.thenewstack.io/media/2023/12/b0026b48-ubuntu.png))
...
Faylning ichidan 
`auth [success=1 default=ignore] pam_unix.so nullok` degan qatorni qidiring. 
